...
func (x *Readiness) GetBackend() string {
	if x != nil {
		return x.Backend
	}
	return ""
...
func (x *Readiness) GetCode() string {
	if x != nil {
		return x.Code
	}
	return ""
...
func (x *Readiness) GetDetail() string {
	if x != nil {
		return x.Detail
	}
	return ""
...
func (x *Readiness) GetCheckedAtUnixMs() int64 {
	if x != nil {
...
func (x *NativeRequest) Reset() {
	*x = NativeRequest{}
	mi := &file_codefly_storage_v0_storage_proto_msgTypes[26]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NativeRequest) Descriptor() ([]byte, []int) {
	return file_codefly_storage_v0_storage_proto_rawDescGZIP(), []int{26}
}
...
func (x *NativeResult) Reset() {
	*x = NativeResult{}
	mi := &file_codefly_storage_v0_storage_proto_msgTypes[27]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NativeResult) Descriptor() ([]byte, []int) {
	return file_codefly_storage_v0_storage_proto_rawDescGZIP(), []int{27}
}
...
const file_codefly_storage_v0_storage_proto_rawDesc = "" +
	...
	"\x12checked_at_unix_ms\x18\x05 \x01(\x03R\x0fcheckedAtUnixMs\"\xa5\x01\n" +
	...
	"\x0fWRITE_OP_DELETE\x10\x022\xbf\a\n" +
	"\rObjectStorage\x12F\n" +
	...
	"\fCapabilities\x12'.codefly.storage.v0.CapabilitiesRequest\x1a'.codefly.storage.v0.BackendCapabilities\x12H\n" +
	"\x05Ready\x12 .codefly.storage.v0.ReadyRequest\x1a\x1d.codefly.storage.v0.Readiness\x12M\n" +
...
var file_codefly_storage_v0_storage_proto_msgTypes = make([]protoimpl.MessageInfo, 33)
var file_codefly_storage_v0_storage_proto_goTypes = []any{
	...
	(*ReadyRequest)(nil),        // 27: codefly.storage.v0.ReadyRequest
	(*Readiness)(nil),           // 28: codefly.storage.v0.Readiness
	(*NativeRequest)(nil),       // 29: codefly.storage.v0.NativeRequest
	(*NativeResult)(nil),        // 30: codefly.storage.v0.NativeResult
	nil,                         // 31: codefly.storage.v0.ObjectInfo.UserMetadataEntry
	nil,                         // 32: codefly.storage.v0.PutHeader.UserMetadataEntry
	nil,                         // 33: codefly.storage.v0.PresignResult.HeadersEntry
	nil,                         // 34: codefly.storage.v0.NativeRequest.ParamsEntry
	nil,                         // 35: codefly.storage.v0.NativeResult.ValuesEntry
}
var file_codefly_storage_v0_storage_proto_depIdxs = []int32{
	31, // 0: codefly.storage.v0.ObjectInfo.user_metadata:type_name -> codefly.storage.v0.ObjectInfo.UserMetadataEntry
	...
	32, // 6: codefly.storage.v0.PutHeader.user_metadata:type_name -> codefly.storage.v0.PutHeader.UserMetadataEntry
	...
	33, // 11: codefly.storage.v0.PresignResult.headers:type_name -> codefly.storage.v0.PresignResult.HeadersEntry
	2,  // 12: codefly.storage.v0.WriteEvent.op:type_name -> codefly.storage.v0.WriteOp
	34, // 13: codefly.storage.v0.NativeRequest.params:type_name -> codefly.storage.v0.NativeRequest.ParamsEntry
	35, // 14: codefly.storage.v0.NativeResult.values:type_name -> codefly.storage.v0.NativeResult.ValuesEntry
	...
	27, // 25: codefly.storage.v0.ObjectStorage.Ready:input_type -> codefly.storage.v0.ReadyRequest
	29, // 26: codefly.storage.v0.ObjectStorage.Native:input_type -> codefly.storage.v0.NativeRequest
	8,  // 27: codefly.storage.v0.ObjectStorage.Stat:output_type -> codefly.storage.v0.GetHeader
	7,  // 28: codefly.storage.v0.ObjectStorage.Get:output_type -> codefly.storage.v0.GetResponse
	11, // 29: codefly.storage.v0.ObjectStorage.Put:output_type -> codefly.storage.v0.PutResult
	13, // 30: codefly.storage.v0.ObjectStorage.Delete:output_type -> codefly.storage.v0.DeleteResult
	15, // 31: codefly.storage.v0.ObjectStorage.DeleteMany:output_type -> codefly.storage.v0.DeleteManyResult
	18, // 32: codefly.storage.v0.ObjectStorage.List:output_type -> codefly.storage.v0.ListResult
	20, // 33: codefly.storage.v0.ObjectStorage.Copy:output_type -> codefly.storage.v0.CopyResult
	22, // 34: codefly.storage.v0.ObjectStorage.Presign:output_type -> codefly.storage.v0.PresignResult
	24, // 35: codefly.storage.v0.ObjectStorage.Watch:output_type -> codefly.storage.v0.WriteEvent
	26, // 36: codefly.storage.v0.ObjectStorage.Capabilities:output_type -> codefly.storage.v0.BackendCapabilities
	28, // 37: codefly.storage.v0.ObjectStorage.Ready:output_type -> codefly.storage.v0.Readiness
	30, // 38: codefly.storage.v0.ObjectStorage.Native:output_type -> codefly.storage.v0.NativeResult
